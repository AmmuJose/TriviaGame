var app = {
        ...
        questions: {
            question0: {
                question: "Which animal can create loudest sound among any living creature?",
                choice: [
                    'Whale Shark',
                    'Gibbon',
                    'Humpback Whales',
            ...
            question1: {
                question: "Which animal exclusively eat only eucalyptus leaves and nothing else?",
                choice: [
                    'Koala',
                    'Greter Glider',
                    'Commom Wombat',
            ...
            question2: {
                question: "Which is the fastest of all the birds?",
                choice: [
                    'Blood Phesant',
                    'Swift',
                    'Sparrow',
            ...
            question3: {
                question: "Which is the world's heaviest land animal?",
                choice: [
                    'Hippopotamus',
                    'African Elephant',
                    'Gorilla',
            ...
            question5: {
                question: 'What playful, semi-aquatic mammal is distinguished for having the thickest fur in the animal kingdom?',
                choice: [
                    'Seal',
                    'Sea Otter',
                    'Beaver',
        ...
        printFirstQuestions: function() {
            ...
            for (var i = 0; i < app.questions.question0.choice.length; i++) {
                html += "<li id='" + app.questions.question0.choice[i] + "' class='answers'>" + app.questions.question0.choice[i] + "</li>";
            }
            html += '</ul>';
            $("#questions").html(html);
        },
        ...
        printQuestion: function() {
            ...
            for (var i = 0; i < app.questions[q].choice.length; i++) {
                html += "<li class='answers' id='" + app.questions[q].choice[i] + "'>" + app.questions[q].choice[i] + "</li>";
            }
            html += '</ul>';
            $("#questions").html(html);
        },
        ...
        printAnswer: function(parentId, childId) {
            ...
            if (childId == app.questions[parentId].answer) {
                html += "<div id='correctOrWrong'>Correct !!</div>";
                ...
                if (!app.isAnswered) {
                    ...
                    html += "<div id='correctOrWrong'>Wrong !!</div>"
                    app.wrongAnswerCount++;
                }
                html += "<div id='correctAnswer'>The correct answer is:  <b> " + app.questions[parentId].answer + " </b></div>";
            }
            html += "<div><img width='200' height='150' src='assets/images/" + app.questions[parentId].image + ".jpg'></div>";
            $("#questions").html(html);
            setTimeout(app.printNextQuestion, 3000);
        },
